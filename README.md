# Mundis Layer1 Substrate Node Template

[![Try on playground](https://img.shields.io/badge/Playground-Node_Template-brightgreen?logo=Parity%20Substrate)](https://docs.substrate.io/playground/) [![Matrix](https://img.shields.io/matrix/substrate-technical:matrix.org)](https://matrix.to/#/#substrate-technical:matrix.org)

A fresh FRAME-based Mundis L1 [Substrate](https://www.substrate.io/) node, ready for hacking :rocket:
...
### Build
First, we need to pin the `syn` package to a version prior to 1.0.98. Run the following commands:
```sh
